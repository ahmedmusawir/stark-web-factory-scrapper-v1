...
[Sign In](https://marketplace.gohighlevel.com/login)
  ...
  * [Marketplace Modules](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Marketplace Policies](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  ...
  * [OAuth 2.0](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Business](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Calendars](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Campaigns](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Companies](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Contacts](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Objects](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Associations](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Custom Fields V2](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Conversations](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Courses](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Email](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Forms](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Invoice](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Trigger Links](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Sub-Account (Formerly location)](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Media Storage](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Developer marketplace](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Blogs](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Funnels](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Opportunities](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Payments](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Products](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Saas](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Snapshots](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Social Planner](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Surveys](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Users](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Workflows](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [LC Email](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Custom menus](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Voice AI](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Proposals](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Knowledge Base](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Conversation AI](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Phone System](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [Store](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
  * [AI Agent Studio](https://marketplace.gohighlevel.com/docs/oauth/ExternalAuthentication/index.html)
...
`grant_type`| `authorization_code` or `refresh_token`| Specifies the type of grant being requested from the authorization server:- `authorization_code`: Used when exchanging the authorization code for access tokens- `refresh_token`: Used when requesting new access tokens using a refresh token  
...
**Section 3:** Test your authentication This section will allow developers to test the authentication flow with sample values.
...
## Share your feedback
★★★★★
[PreviousExternal Billing](https://marketplace.gohighlevel.com/docs/oauth/Billing)[NextUser Context in Marketplace Apps](https://marketplace.gohighlevel.com/docs/other/user-context-marketplace-apps)
