[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html#__docusaurus_skipToContent_fallback)
...
[Sign In](https://marketplace.gohighlevel.com/login)
  ...
  * [Marketplace Modules](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Marketplace Policies](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  ...
  * [OAuth 2.0](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Business](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Calendars](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Campaigns](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Companies](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Contacts](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Objects](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Associations](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Custom Fields V2](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Conversations](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Courses](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Email](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Forms](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Invoice](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Trigger Links](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Sub-Account (Formerly location)](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Media Storage](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Developer marketplace](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Blogs](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Funnels](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Opportunities](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Payments](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Products](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Saas](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Snapshots](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Social Planner](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Surveys](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Users](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Workflows](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [LC Email](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Custom menus](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Voice AI](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  ...
  * [Proposals](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Knowledge Base](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Conversation AI](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Phone System](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [Store](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
  * [AI Agent Studio](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html)
...
#### Token Type(s)
`Sub-Account Token`
## Request[​](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html#request "Direct link to Request")
### Header Parameters
...
## Responses[​](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-logs/index.html#responses "Direct link to Responses")
  * 200
  * 400
  * 401
...
```
**name:** Authorization[](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/voice-ai-api#authentication)**type: **http**scopes: **voice-ai-dashboard.readonly**scheme: **bearer**bearerFormat: **JWT**in: **header**description: **Use the Access Token generated with user type as Sub-Account (OR) Private Integration Token of Sub-Account.
```
...
endDate — query
actionType — query
---CALL_TRANSFERDATA_EXTRACTIONIN_CALL_DATA_EXTRACTIONWORKFLOW_TRIGGERSMSAPPOINTMENT_BOOKINGCUSTOM_ACTIONKNOWLEDGE_BASE
sortBy — query
---durationcreatedAt
sort — query
---ascenddescend
...
[PreviousDashboard](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/dashboard)[NextGet Call Log](https://marketplace.gohighlevel.com/docs/ghl/voice-ai/get-call-log)