...
[Sign In](https://marketplace.gohighlevel.com/login)
  ...
  * [Marketplace Modules](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Marketplace Policies](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  ...
  * [OAuth 2.0](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Business](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Calendars](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Campaigns](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Companies](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Contacts](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Objects](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Associations](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Custom Fields V2](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Conversations](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Courses](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Email](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Forms](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Invoice](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Trigger Links](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Sub-Account (Formerly location)](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Media Storage](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Developer marketplace](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Blogs](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Funnels](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Opportunities](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Payments](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  ...
  * [Products](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Saas](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Snapshots](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Social Planner](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Surveys](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Users](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Workflows](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [LC Email](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Custom menus](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Voice AI](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Proposals](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Knowledge Base](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Conversation AI](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Phone System](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [Store](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
  * [AI Agent Studio](https://marketplace.gohighlevel.com/docs/ghl/payments/list-order-fulfillment/index.html)
...
```
**name:** Authorization[](https://marketplace.gohighlevel.com/docs/ghl/payments/payments-api#authentication)**type: **http**scopes: **payments/orders.readonly**scheme: **bearer**bearerFormat: **JWT**in: **header**description: **Use the Access Token generated with user type as Sub-Account (OR) Private Integration Token of Sub-Account.
```
...
[PreviousCreate order fulfillment](https://marketplace.gohighlevel.com/docs/ghl/payments/create-order-fulfillment)[NextOrder Notes](https://marketplace.gohighlevel.com/docs/ghl/payments/order-notes)