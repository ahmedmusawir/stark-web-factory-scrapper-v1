...
[Sign In](https://marketplace.gohighlevel.com/login)
  ...
  * [Marketplace Modules](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Marketplace Policies](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  ...
  * [Business](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Calendars](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Campaigns](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Companies](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Contacts](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Objects](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Associations](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Custom Fields V2](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Conversations](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Courses](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Email](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Forms](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Invoice](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Trigger Links](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Sub-Account (Formerly location)](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Media Storage](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Developer marketplace](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Blogs](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Funnels](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Opportunities](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Payments](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Products](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Saas](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Snapshots](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Social Planner](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Surveys](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Users](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Workflows](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [LC Email](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Custom menus](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Voice AI](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Proposals](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Knowledge Base](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Conversation AI](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Phone System](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [Store](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
  * [AI Agent Studio](https://marketplace.gohighlevel.com/docs/Authorization/OAuth2.0/index.html)
...
![drawing](https://storage.googleapis.com/msgsndr/HjiMUOsCCHCjtxzEf8PR/media/6899b9f5af6a321b106b6397.png)
  1. After creating the APP you will be taken to the Profile section where you will need to add the details related to your APP. For eg; APP Logo, category, Company Name, APP Description, preview images etc.
  2. After completing the profile details, please click on the Advanced Settings drop down available in the left pane and go to the auth section.
  3. The Auth page will appear as shown in the screenshot below. This is where you’ll configure essential settings for your app’s OAuth integration, including scopes, redirect URLs, and client credentials.
...
![drawing](https://storage.googleapis.com/msgsndr/HjiMUOsCCHCjtxzEf8PR/media/6899c23c924ed941ae8bb2c4.png)
  1. Select the account you want to install the APP in.
  2. When a user grants access, their browser is redirected to the specified redirect URI, and the Authorization Code is passed inside the code query parameter.
...
```
  ...
  1. **Access Token with User Type as Location:** This Type of Access Token will be utilized to run the APIs related to the Sub-Account or Location Functionalities. For eg; [Create Contact API.](https://marketplace.gohighlevel.com/docs/ghl/contacts/create-contact)
...
## Share your feedback
★★★★★
[PreviousPrivate Integrations Token](https://marketplace.gohighlevel.com/docs/Authorization/PrivateIntegrationsToken)[NextDeveloper Glossary of Terms](https://marketplace.gohighlevel.com/docs/Authorization/DeveloperGlossary)
