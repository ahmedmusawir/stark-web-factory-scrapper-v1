...
[Sign In](https://marketplace.gohighlevel.com/login)
  ...
  * [Marketplace Modules](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Marketplace Policies](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  ...
  * [OAuth 2.0](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Business](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Calendars](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Campaigns](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Companies](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Contacts](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Objects](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Associations](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Custom Fields V2](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Conversations](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Courses](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Email](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Forms](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Invoice](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Trigger Links](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Sub-Account (Formerly location)](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Media Storage](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Developer marketplace](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Blogs](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Funnels](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Opportunities](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Payments](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Products](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Saas](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Snapshots](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Social Planner](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Surveys](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Users](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  ...
  * [Workflows](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [LC Email](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Custom menus](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Voice AI](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Proposals](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Knowledge Base](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Conversation AI](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Phone System](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [Store](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
  * [AI Agent Studio](https://marketplace.gohighlevel.com/docs/ghl/users/update-user/index.html)
...
```
**name:** Authorization[](https://marketplace.gohighlevel.com/docs/ghl/users/users-api#authentication)**type: **http**scopes: **users.write**scheme: **bearer**bearerFormat: **JWT**in: **header**description: **Use the Access Token generated with user type as Agency (OR) Private Integration Token of Agency.
```
...
[PreviousGet User](https://marketplace.gohighlevel.com/docs/ghl/users/get-user)[NextDelete User](https://marketplace.gohighlevel.com/docs/ghl/users/delete-user)