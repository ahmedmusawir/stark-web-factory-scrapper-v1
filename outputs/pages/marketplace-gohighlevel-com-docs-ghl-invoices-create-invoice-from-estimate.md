...
[Sign In](https://marketplace.gohighlevel.com/login)
  ...
  * [Marketplace Modules](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Marketplace Policies](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  ...
  * [OAuth 2.0](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Business](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Calendars](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Campaigns](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Companies](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Contacts](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Objects](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Associations](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Custom Fields V2](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Conversations](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Courses](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Email](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Forms](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Invoice](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  ...
  * [Trigger Links](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Sub-Account (Formerly location)](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Media Storage](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Developer marketplace](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Blogs](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Funnels](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Opportunities](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Payments](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Products](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Saas](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Snapshots](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Social Planner](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Surveys](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Users](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Workflows](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [LC Email](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Custom menus](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Voice AI](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Proposals](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Knowledge Base](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Conversation AI](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Phone System](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [Store](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
  * [AI Agent Studio](https://marketplace.gohighlevel.com/docs/ghl/invoices/create-invoice-from-estimate/index.html)
...
```
**name:** Authorization[](https://marketplace.gohighlevel.com/docs/ghl/invoices/invoice-api#authentication)**type: **http**scopes: **invoices/estimate.write**scheme: **bearer**bearerFormat: **JWT**in: **header**description: **Use the Access Token generated with user type as Sub-Account (OR) Private Integration Token of Sub-Account.
```
...
[PreviousSend Estimate](https://marketplace.gohighlevel.com/docs/ghl/invoices/send-estimate)[NextList Estimates](https://marketplace.gohighlevel.com/docs/ghl/invoices/list-estimates)