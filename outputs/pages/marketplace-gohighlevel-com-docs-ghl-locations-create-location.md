...
[Sign In](https://marketplace.gohighlevel.com/login)
  ...
  * [Marketplace Modules](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Marketplace Policies](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  ...
  * [OAuth 2.0](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Business](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Calendars](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Campaigns](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Companies](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Contacts](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Objects](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Associations](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Custom Fields V2](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Conversations](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Courses](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Email](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Forms](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Invoice](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Trigger Links](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Sub-Account (Formerly location)](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
    ...
    * [Sub-Account (Formerly Location)](https://marketplace.gohighlevel.com/docs/ghl/locations/sub-account-formerly-location)
      * [Get Sub-Account (Formerly Location)](https://marketplace.gohighlevel.com/docs/ghl/locations/get-location)
      * [Put Sub-Account (Formerly Location)](https://marketplace.gohighlevel.com/docs/ghl/locations/put-location)
      * [Delete Sub-Account (Formerly Location)](https://marketplace.gohighlevel.com/docs/ghl/locations/delete-location)
      * [Create Sub-Account (Formerly Location)](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location)
  ...
  * [Media Storage](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Developer marketplace](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Blogs](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Funnels](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Opportunities](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Payments](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Products](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Saas](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Snapshots](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Social Planner](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Surveys](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Users](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Workflows](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [LC Email](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Custom menus](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Voice AI](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Proposals](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Knowledge Base](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Conversation AI](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Phone System](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [Store](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
  * [AI Agent Studio](https://marketplace.gohighlevel.com/docs/ghl/locations/create-location/index.html)
...
```
**name:** Authorization[](https://marketplace.gohighlevel.com/docs/ghl/locations/sub-account-formerly-location-api#authentication)**type: **http**scopes: **locations.write**scheme: **bearer**bearerFormat: **JWT**in: **header**description: **Use the Access Token generated with user type as Agency (OR) Private Integration Token of Agency.
```
...
[PreviousDelete Sub-Account (Formerly Location)](https://marketplace.gohighlevel.com/docs/ghl/locations/delete-location)[NextTags](https://marketplace.gohighlevel.com/docs/ghl/locations/tags)