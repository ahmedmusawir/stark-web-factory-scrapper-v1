...
[Sign In](https://marketplace.gohighlevel.com/login)
  ...
  * [Marketplace Modules](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
    ...
    * [Workflow Actions and Triggers](https://marketplace.gohighlevel.com/docs/marketplace-modules/WorkflowActionsAndTriggers)
      * [Marketplace Workflow Actions](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions)
      * [Marketplace Workflow Triggers](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomTriggers)
    ...
    * [Custom JS](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Marketplace Policies](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  ...
  * [OAuth 2.0](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Business](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Calendars](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Campaigns](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Companies](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Contacts](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Objects](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Associations](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Custom Fields V2](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Conversations](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Courses](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Email](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Forms](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Invoice](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Trigger Links](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Sub-Account (Formerly location)](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Media Storage](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Developer marketplace](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Blogs](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Funnels](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Opportunities](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Payments](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Products](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Saas](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Snapshots](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Social Planner](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Surveys](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Users](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Workflows](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [LC Email](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Custom menus](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Voice AI](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Proposals](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Knowledge Base](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Conversation AI](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Phone System](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [Store](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
  * [AI Agent Studio](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomActions/index.html)
...
![drawing](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155046654687/original/wlQ-4aQO5LpNdpJbhzMNHN2oNPiD95H3sw.png?1747285021)
  * **Name** _Enter Field Name_
  * **Type** _Select one of the following field types:_ String, Numerical, Textarea, Select, Multiple Select, Radio, Toggle, Checkbox, Attachment, Rich Text Editor, Hidden, Dynamic
  * **Required** _Enable if this is a required field in workflow._
  * **Reference** _Enter unique reference key. The value of this field will be bind to the provided key. Example: action_a_name_
  * **Default Value** _Enter or map a value. The value provided will be used as default value for this field when loaded in workflow._
  * **Alters Dynamic Field** _If enabled, any changes made to this field value will trigger/ re-trigger loading the dynamic fields to the workflow action configuration UI._
  * **Validation Rules** _Validation Rules let you protect data quality by checking the value a user types into a form field, table cell, or configuration input before it is saved or passed downstream._ _If the value fails the check, HighLevel blocks the save/submit action and shows a custom error message that you configure._
...
![drawing](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155005617938/original/xkySDB0XDrua62JzPisbo1TNQH59sEZSaw.png?1692595922)
  * **Internal Reference** Load options from HighLevel Internal Modules
...
**URL (POST)** Enter your API endpoint URL. When executed data is sent to this API endpoint via POST method.
**Headers** Add headers as per your requirement
**Sample Payload:**
```
...
![drawing](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155046654729/original/-BqA09IMW6XXljUIMVpOefqpJJ_JkQ2TWg.png?1747285143)
  * **Pre-defined Rules** Easily apply common validations such as email, phone number, URL, numerical values, and handlebar syntax checks.
...
![drawing](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155046654763/original/XDtbol7Qdfx4-ahKv5gkVKT415lhZivHPw.png?1747285248)
  * **Regex Support** Use custom regular expressions to validate inputs against specific patterns.
...
![drawing](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155046654765/original/mLG5Rv1JMo5y6MlQZVQfNmcY0Wucw3jr5w.png?1747285258)
  * **Arrow Function** Write custom arrow functions that receive the input value and return true or false based on whether the validation passes or fails.
...
**URL (POST)** Enter your API endpoint URL. When this action is executed data is sent to this API endpoint via POST method.
**Headers** Add required header data that has to be included while sending data to the API endpoint
**Sample Payload:**
```
{"data":{"name":"John Doe","age":"29","gender":"male","hobbies":["sports","music"],"address":"My Address","country":"US","profileType":"public","dataShare":true,"tems":true},"extras":{"locationId":"xyz","contactId":"abc","workflowId":"def"},"meta":{"key":"custom_action_key","version":"1.0"}}
```
...
This toggle is used the contact will be held at this action unless resume webhook is requested. If this toggle is true then provided extras object needs to be passed as body payload for resume workflow endpoint.
...
![drawing](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155005620775/original/l4xln2C5D1jyZxTEv-jahSqBadZkpCvuzA.png?1692600290)
  * **Name** _Enter label name_
  * **Reference** _Select a reference key from the sample response saved to Response Data._
...
[PreviousGoHighLevel Marketplace Workflow Triggers & Actions](https://marketplace.gohighlevel.com/docs/marketplace-modules/WorkflowActionsAndTriggers)[NextMarketplace Workflow Triggers](https://marketplace.gohighlevel.com/docs/marketplace-modules/CustomTriggers)
