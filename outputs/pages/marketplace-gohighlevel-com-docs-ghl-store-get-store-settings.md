[Skip to main content](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html#__docusaurus_skipToContent_fallback)
...
[Sign In](https://marketplace.gohighlevel.com/login)
  ...
  * [Marketplace Modules](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Marketplace Policies](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  ...
  * [OAuth 2.0](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Business](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Calendars](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Campaigns](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Companies](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Contacts](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Objects](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Associations](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Custom Fields V2](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Conversations](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Courses](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Email](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Forms](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Invoice](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Trigger Links](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Sub-Account (Formerly location)](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Media Storage](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Developer marketplace](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Blogs](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Funnels](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Opportunities](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Payments](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Products](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Saas](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Snapshots](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Social Planner](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Surveys](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Users](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Workflows](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [LC Email](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Custom menus](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Voice AI](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Proposals](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Knowledge Base](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Conversation AI](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Phone System](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  * [Store](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
  ...
  * [AI Agent Studio](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html)
...
#### Token Type(s)
`Sub-Account Token`
## Request[​](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html#request "Direct link to Request")
### Query Parameters
...
## Responses[​](https://marketplace.gohighlevel.com/docs/ghl/store/get-store-settings/index.html#responses "Direct link to Responses")
  * 200
  * 400
  * 401
  * 422
...
[PreviousCreate/Update Store Settings](https://marketplace.gohighlevel.com/docs/ghl/store/create-store-setting)[NextIntroduction](https://marketplace.gohighlevel.com/docs/ghl/agent-studio/agent-studio-api)